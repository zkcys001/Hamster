...
def build_data_loader(args, dataset_name, root, batch_size=64, shuffle=False, num_workers=4, use_iterator=False):
    if dataset_name == 'imagenet-train-sub':
        ...
        pipline_test = transform_test = transforms.Compose([
            transforms.ToTensor(),
    ...
    data_loader = torch.utils.data.DataLoader(data_folder, batch_size, shuffle=shuffle, num_workers=1)
