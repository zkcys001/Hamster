...
from timm.models.helpers import build_model_with_cfg, overlay_external_default_cfg,load_checkpoint
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 use_checkpoint=False, weight_init='', args=None, imagenet_dir=None, **kwargs):
        super().__init__()
        ...
        self.layers_name = ['Layer{}'.format(i) for i in range(6)]
...
@register_model
def swin_tiny_patch4_window7_224(pretrained=False, args=None, imagenet_dir=None, **kwargs):
    """ Swin-T @ 224x224, trained ImageNet-1k
    """
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24), args=args, imagenet_dir =imagenet_dir, **kwargs)
    model = _create_swin_transformer('swin_tiny_patch4_window7_224', pretrained=False, **model_kwargs)
    if pretrained:
        weight_path = osp.join(args.torch_root, 'checkpoints', 'swin_tiny_patch4_window7_224.pth')
...
def SWIM(method, model_name, args=None, imagenet_dir=None, **kwargs):
    model = __factory[model_name](args=args, imagenet_dir=imagenet_dir, **kwargs)
    return model
