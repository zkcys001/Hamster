...
def get_an_instance(folder_name, imagenet_root=r'F:\dataset\classification\mini-imagenet\val'):
    image_file = random.choice(os.listdir(osp.join(imagenet_root, folder_name)))
    return osp.join(imagenet_root, folder_name, image_file)
